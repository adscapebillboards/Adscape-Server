...
-- CreateTable
CREATE TABLE "AdscapePlayer" (
    "id" UUID NOT NULL,
    "screenId" VARCHAR(64) NOT NULL,
    ...
    "appVersionCode" VARCHAR(20),
    "lastSeen" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "AdscapePlayer_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UserBMI" (
    ...
    CONSTRAINT "UserBMI_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AdscapePlayer_screenId_key" ON "AdscapePlayer"("screenId");
...
-- AddForeignKey
ALTER TABLE "BMI" ADD CONSTRAINT "BMI_userId_fkey" FOREIGN KEY ("userId") REFERENCES "UserBMI"("id") ON DELETE SET NULL ON UPDATE CASCADE;
